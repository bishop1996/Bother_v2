...
export function FinderGrid(props) {
    ...
    useLayoutEffect(() => {
        setItemCount && contentList && setItemCount(contentList.length)
    })
    ...
    useLayoutEffect(() => {
        setFinderTitle &&
            setFinderTitle(
                pathMetaData !== null
                    ? pathMetaData.path_display
                          .substring(
                              pathMetaData.path_display.lastIndexOf("/"),
                              pathMetaData.path_display.length
                          )
                          .replace("/", "")
                    : null
            )
    ...
    const handleContentItemClick = targetName => {
            ...
            {source === "Dropbox" && !accessToken ? (
                ...
                <div style={gridStyle()}>
                    {isDataLoading && source === "Dropbox" ? (
                        ...
                        <p>{fetchError.error.error_summary}</p>
                    ) : (
