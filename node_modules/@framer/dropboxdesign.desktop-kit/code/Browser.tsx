...
import { TrafficLights } from "./Subcomponents/TrafficLights"
...
export function Browser(props) {
    ...
    return (
        <Frame name="Browser" {...rest} style={browserStyle}>
            ...
            <Frame name="Content Wrapper" style={contentStyle(HEADER_HEIGHT)}>
                {live ? (
                    <MemoizedWebView {...viewPortProps} url={url} />
                ) : ACTUAL_CHILD ? (
                    <Scroll {...viewPortProps}>{ACTUAL_CHILD}</Scroll>
                ) : (
                    <DefaultInstructions
                        {...viewPortProps}
            ...
            <TrafficLights
                top={browser === "Safari" ? 13 : 16}
                left={browser === "Safari" ? 13 : 15}
            />
        </Frame>
    )
}
